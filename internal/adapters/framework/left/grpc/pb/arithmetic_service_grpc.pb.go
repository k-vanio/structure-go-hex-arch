...
// - protoc             v3.12.4
// source: internal/adapters/framework/left/grpc/proto/arithmetic_service.proto
...
type ArithmeticServiceClient interface {
	GetAddition(ctx context.Context, in *Params, opts ...grpc.CallOption) (*Answer, error)
	GetSubtraction(ctx context.Context, in *Params, opts ...grpc.CallOption) (*Answer, error)
	GetMultiplication(ctx context.Context, in *Params, opts ...grpc.CallOption) (*Answer, error)
	GetDivision(ctx context.Context, in *Params, opts ...grpc.CallOption) (*Answer, error)
}
...
func (c *arithmeticServiceClient) GetAddition(ctx context.Context, in *Params, opts ...grpc.CallOption) (*Answer, error) {
	out := new(Answer)
...
func (c *arithmeticServiceClient) GetSubtraction(ctx context.Context, in *Params, opts ...grpc.CallOption) (*Answer, error) {
	out := new(Answer)
...
func (c *arithmeticServiceClient) GetMultiplication(ctx context.Context, in *Params, opts ...grpc.CallOption) (*Answer, error) {
	out := new(Answer)
...
func (c *arithmeticServiceClient) GetDivision(ctx context.Context, in *Params, opts ...grpc.CallOption) (*Answer, error) {
	out := new(Answer)
...
type ArithmeticServiceServer interface {
	GetAddition(context.Context, *Params) (*Answer, error)
	GetSubtraction(context.Context, *Params) (*Answer, error)
	GetMultiplication(context.Context, *Params) (*Answer, error)
	GetDivision(context.Context, *Params) (*Answer, error)
}
...
func (UnimplementedArithmeticServiceServer) GetAddition(context.Context, *Params) (*Answer, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAddition not implemented")
}
func (UnimplementedArithmeticServiceServer) GetSubtraction(context.Context, *Params) (*Answer, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSubtraction not implemented")
}
func (UnimplementedArithmeticServiceServer) GetMultiplication(context.Context, *Params) (*Answer, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetMultiplication not implemented")
}
func (UnimplementedArithmeticServiceServer) GetDivision(context.Context, *Params) (*Answer, error) {
...
func _ArithmeticService_GetAddition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetAddition(ctx, req.(*Params))
	}
...
func _ArithmeticService_GetSubtraction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetSubtraction(ctx, req.(*Params))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ArithmeticService_GetMultiplication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetMultiplication(ctx, req.(*Params))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _ArithmeticService_GetDivision_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ArithmeticServiceServer).GetDivision(ctx, req.(*Params))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ArithmeticService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/adapters/framework/left/grpc/proto/arithmetic_service.proto",
}
